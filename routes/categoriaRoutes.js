...
router.put("/:id", validateIdParam, autenticar, esEmpleado, categoriaController.update);
router.delete("/:id", validateIdParam, autenticar, esEmpleado, categoriaController.delete);
